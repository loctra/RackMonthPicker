...
public class RackMonthPicker {
    ...
    private class Builder implements MonthAdapter.OnSelectedListener {
        ...
        private Builder() {
            ...
            ImageView next = contentView.findViewById(R.id.btn_next);
            next.setOnClickListener(nextButtonClick());

            ImageView previous = contentView.findViewById(R.id.btn_previous);
            ...
            mTitleView.setText(String.valueOf(monthAdapter.getShortMonth() + ", " + year));
